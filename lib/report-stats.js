...
const RESULT_HEADER_EXACT = new Set(['android', 'ios', 'p/f', 'pf', 'pass/fail', 'mobile', 'web']);
...
module.exports = { classifyResult, detectResultColumns, findTcIdColumn, computeStatsFromSheetData };
